<template>
  <div class="container md:w-8/12 md:mr-80">
    ...
    <p class="text-xl md:text-4xl">Could be a hair, could be ketchup, or it could be your next idea - 
      comes <a href="https://calendly.com/b-yun/say-hi-to-beaumont" class="text-blue-450">say hi</a> and don't be shy, I always have a cup of coffee in hand to hear your thoughts</p>
    <br>
